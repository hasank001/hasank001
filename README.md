...
![SCL](https://img.shields.io/badge/SCL-0078D4?style=for-the-badge&logoColor=white)
![Delta PLC](https://img.shields.io/badge/Delta%20PLC-E30613?style=for-the-badge&logoColor=white)
![SCADA](https://img.shields.io/badge/SCADA-2C3E50?style=for-the-badge&logoColor=white)
![OPC UA](https://img.shields.io/badge/OPC%20UA-005A9C?style=for-the-badge&logoColor=white)
![Modbus](https://img.shields.io/badge/Modbus-444444?style=for-the-badge&logoColor=white)
![EPLAN](https://img.shields.io/badge/EPLAN-A8C500?style=for-the-badge&logoColor=black)

**Yapay Zeka & Goruntu Isleme**

![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=for-the-badge&logo=opencv&logoColor=white)
![NumPy](https://img.shields.io/badge/NumPy-013243?style=for-the-badge&logo=numpy&logoColor=white)
![Machine Learning](https://img.shields.io/badge/Makine%20%C3%96%C4%9Frenmesi-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white)
![LiDAR](https://img.shields.io/badge/LiDAR%20%2F%203D-00B4D8?style=for-the-badge&logoColor=white)
...
Tam otomatik uretim hatlarinin elektrik ve yazilim tarafini uctan uca yurutuyorum. Projelerin elektrik tasariminden PLC yazilimina, SCADA mimarisinden devreye almaya kadar tum sureclerde aktif rol aliyorum.

**Uzman Egitmen** — Konya Buyuksehir Belediyesi (Konya Bilim Tini)  &nbsp; `09/2022 - 02/2023`

Bilim merkezinde egitmenlik yaptim.
...
`EPLAN` - `TIA Portal` - `SCL` - `OPC UA` - `C# SCADA`

### Tam Otomatik Mermer Plaka Silim Makinesi
**Delta PLC** altyapisiyla makinenin elektriksel donanim mimarisini cizdim, saha entegrasyonlarini ve devreye alma operasyonlarini tamamladim. Sisteme **LiDAR** sensor teknolojisini entegre ederek hareketli konveyor uzerindeki mermerlerin 3D yuzey haritasini milimetrik hassasiyetle cikaran veri isleme algoritmalari yazdim. **Modbus** ile donanim verilerini **C# SCADA** uygulamasina aktarip gercek zamanli 3D simulasyon sureclerini isledim. Simulasyon verisine dayanarak silim eksenini anlik hesaplayan, otonom tepki veren bir "karar alma" mekanizmasi kurdum.

`Delta PLC` - `LiDAR / 3D` - `Modbus` - `C# SCADA` - `Otonom Karar`
